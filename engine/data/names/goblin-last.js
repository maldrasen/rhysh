let names = [
  ...
  { name:"Assripper", aspects:['ass-obsessed.3','stretcher.2'], triggers:['monster-cock'], restriction:_notFemale},
  ...
  { name:"Clitcock", triggers:['monster-clit'], restriction:_female},
  ...
  { name:"Cumdripper", triggers:['big-balls'], restriction:_notFemale},
  { name:"Cumdumpster", aspects:['androphilic','cum-lover.3']},
  { name:"Cumfarts", aspects:['androphilic','cum-lover','anal-slut']},
  { name:"Cumriver", triggers:['monster-balls'], restriction:_notFemale},
  ...
  { name:"Cuntdestroyer", aspects:['gynephilic','pussy-lover.2','stretcher.2','violent'], triggers:['monster-cock'], restriction:_notFemale},
  ...
  { name:"Cursecock", triggers:['monster-cock'], restriction:_notFemale},
  ...
  { name:"Emergency" },
  { name:"Fatcock", triggers:['big-cock'], restriction:_notFemale},
  { name:"Fatcocks", triggers:['big-cock','multi-cock'], restriction:_notFemale},
  { name:"Flavored" },
  ...
  { name:"Horsecock", triggers:['horse-cock'], restriction:_notFemale},
  { name:"Horsecocks", triggers:['horse-cock','multi-cock'], restriction:_notFemale},
  ...
  { name:"Shittingdicknipples", aspects:['revolting'], triggers:['dick-nipples'], restriction:_female},
  { name:"Shittingnipplecunts", aspects:['revolting'], triggers:['nipple-cunts'], restriction:_female},
  ...
  { name:"Threecocks", triggers:['multi-cock','multi-cock'], restriction:_notFemale},
