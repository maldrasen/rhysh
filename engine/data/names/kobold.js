let names = [
 { name:"After-Dinner-Mint", aspects:['pussy-slut','slut'], restriction:_female},
 { name:"After-It-Rains", aspects:['passive']},
 { name:"Always-In-Heat", aspects:['pussy-slut','breeder.3','slut'], restriction:_female},
 { name:"Always-Screaming", aspects:['violent','masochist.3']},
 { name:"Amber-Eyes", triggers:['amber-eyes','beautiful']},
 { name:"Angry-At-Everything", restriction:_male, aspects:['violent.2']},
 { name:"Any-Hole-Will-Do", aspects:['ass-obsessed.2','pussy-lover.2','oral-lover.2','slut.3'], restriction:_notFemale},
 ...
 { name:"Badass-Motherfucker", restriction:_male, triggers:['strong','smart']},
 { name:"Bares-His-Fangs", restriction:_male, aspects:['violent']},
 ...
 { name:"Black-Silk-Earth", restriction:_female, triggers:['beautiful']},
 { name:"Breaks-An-Arm", aspects:['violent']},
 { name:"Breezes-Whisper", aspects:['passive']},
 { name:"Builds-A-Nest", aspects:['breeder'], restriction:_female},
 ...
 { name:"Chases-A-Tail", aspects:['slut.3','pussy-lover.2','gynephilic.3'], restriction:_notFemale },
 { name:"Chews-On-Moss" },
 ...
 { name:"Cuts-With-Words", triggers:['smart'], restriction:_female },
 { name:"Dances-In-The-Fire" },
 { name:"Dances-Naked", aspects:['slut.2','pussy-slut','anal-slut'], restriction:_female },
 { name:"Dances-With-A-Knife", restriction:_female },
 { name:"Dances-With-The-Moon", restriction:_female },
 { name:"Dances-With-Wolves", aspects:['beast-lover']},
 { name:"Delves-Deeply", triggers:['smart']},
 { name:"Dies-Horribly", restriction:_male },
 ...
 { name:"Eats-Too-Much", restriction:_male },
 ...
 { name:"Finds-A-Cave" },
 { name:"Finds-A-Secret" },
 { name:"Fire-Under-His-Tongue", triggers:['smart','magical'], restriction:_male },
 { name:"Fires-An-Arrow" },
 { name:"Flicks-His-Tongue", restriction:_male },
 { name:"Follows-After" },
 ...
 { name:"Fucks-His-Mother", aspects:['perverted.3','slut.3'], restriction:_male },
 { name:"Furl-Of-Fresh-Leaves", aspects:['passive.2'], triggers:['beautiful']},
 { name:"Gives-A-Beating", aspects:['violent.2'], restriction:_male },
 { name:"Gives-A-Hand", aspects:['passive']},
 { name:"Goes-All-The-Way", aspects:['slut.2','pussy-slut','anal-slut'], restriction:_female },
 ...
 { name:"Grows-A-Beard", restriction:_male },
 { name:"Grows-A-Tail", aspects:['revolting.2']},
 { name:"Grows-Long", triggers:['big-cock'], restriction:_notFemale },
 { name:"Grows-Mushrooms", aspects:['passive']},
 { name:"Hard-As-A-Rock", triggers:['big-cock'], restriction:_notFemale },
 { name:"Has-A-Bucket", triggers:['stupid']},
 { name:"Has-No-Regrets" },
 { name:"Has-Trouble-Acting-Normal", aspects:['perverted.3'], triggers:['stupid'], restriction:_male },
 { name:"He-Cuts-The-Flesh", aspects:['violent.2'], restriction:_male },
 ...
 { name:"Hides-A-Card" },
 { name:"Hides-His-Eyes", restriction:_male },
 { name:"Hides-In-Shadows" },
 { name:"His-Tongue-Is-A-Dick", triggers:['cock-tongue'], restriction:_male },
 { name:"Holds-A-Torch" },
 ...
 { name:"Inside-Out-Ass", restriction:_female, triggers:['anal-prolapse']},
 { name:"Jacks-Off-A-Horse", aspects:['beast-lover.3','cock-lover.3','cum-lover'], restriction:_female },
 ...
 { name:"Lifts-Her-Tail", aspects:['slut.3','pussy-slut.2','anal-slut','perverted'], restriction:_female },
 ...
 { name:"Makes-An-Arrow" },
 { name:"Makes-Honey", aspects:['passive.2','pussy-slut.3','golden.2'], restriction:_notMale },
 { name:"Marks-The-Prey", aspects:['violent'], triggers:['smart']},
 { name:"Meat-Stick", triggers:['big-cock'], restriction:_notFemale },
 { name:"Milks-A-Goat", aspects:['beast-lover','tit-lover.2','milky.2']},
 { name:"Misses-The-Target", triggers:['stupid']},
 { name:"Moist-For-No-Reason" },
 { name:"Morning-Star-Steals-Away-Clouds", triggers:['beautiful'], restriction:_notMale },
 { name:"Mother-Of-The-Moon", aspects:['breeder.2'], restriction:_female },
 { name:"Mounts-A-Boar", aspects:['beast-lover.3'], restriction:_notFemale },
 { name:"Moves-Like-Water" },
 { name:"Moves-Many-Rocks", triggers:['strong']},
 { name:"Names-The-Leaves", triggers:['smart','beautiful']},
 { name:"Narrows-His-Eyes", restriction:_male },
 { name:"Never-Clever", triggers:['stupid']},
 { name:"One-Eye-Green" },
 { name:"Only-He-Stands-There", restriction:_male },
 { name:"Opens-His-Eyes", restriction:_male },
 { name:"Paints-With-Dreams", aspects:['passive.2'], triggers:['magical'], restriction:_female },
 { name:"Picks-A-Flower", aspects:['passive.3'], restriction:_female },
 { name:"Pisses-In-The-Wind", restriction:_notFemale },
 { name:"Plays-A-Flute" },
 { name:"Plays-A-Game" },
 { name:"Plays-With-Himself", aspects:['masterbator'], restriction:_male },
 { name:"Poisons-A-Well" },
 { name:"Poor-Impulse-Control", aspects:['perverted','violent','masterbator'], restriction:_male },
 { name:"Pours-A-Glass" },
 ...
 { name:"Runs-To-The-Shitter", aspects:['revolting'], restriction:_male },
 { name:"Runs-With-Wolves", aspects:['beast-lover']},
 { name:"Scattered-Leaves", triggers:['beautiful'] },
 { name:"Scent-Of-The-Graves" },
 { name:"Screams-Of-Fire-And-Damnation", aspects:['chaste','violent'], triggers:['magical'], restriction:_male },
 { name:"Searches-For-Gold" },
 { name:"Sees-In-The-Dark" },
 { name:"Serves-On-Her-Knees", aspects:['androphilic','cock-lover.2','oral-slut.3'], restriction:_female },
 { name:"Sets-A-Trap" },
 { name:"Sharpens-A-Blade" },
 { name:"Shouts-At-The-Sky", aspects:['violent'], triggers:['magical','stupid']},
 { name:"Shows-His-Teeth", aspects:['violent'], restriction:_male },
 { name:"Shows-The-Way" },
 { name:"Silver-Scales", triggers:['white-scales']},
 { name:"Sings-Her-Sorrows", aspects:['passive'], restriction:_female },
 ...
 { name:"Sister-Of-The-Wind", restriction:_female },
 { name:"Skins-A-Deer" },
 { name:"Slap-Her-Ass", aspects:['masochist.2','anal-slut'], restriction:_female },
 { name:"Sleeps-All-Day", aspects:['passive']},
 { name:"Slim-Pickins" },
 { name:"Slips-Through-Fingers" },
 { name:"Sloppy-Seconds", aspects:['slut'], restriction:_female },
 { name:"Smells-Like-Shit", aspects:['golden.2','revolting.3'], restriction:_male },
 ...
 { name:"Sorry-He's-Here", triggers:['ugly','weak','stupid'], restriction:_male },
 ...
 { name:"Speaks-With-Her-Sword", aspects:['violent.2'], restriction:_female },
 { name:"Speaks-With-Leaves", aspects:['passive.3']},
 { name:"Spreads-Her-Legs", aspects:['pussy-slut.3','breeder.3'], restriction:_female },
 { name:"Stands-Alone" },
 ...
 { name:"Takes-A-Rabbit" },
 { name:"Takes-Her-Time", aspects:['passive'], restriction:_female },
 { name:"Takes-In-Light", aspects:['passive']},
 { name:"Takes-The-Shot" },
 { name:"Talks-To-Himself", restriction:_male },
 { name:"Talks-To-Shadows" },
 { name:"Talks-To-Trees", aspects:['passive']},
 { name:"Talks-Too-Much" },
 { name:"Tames-A-Fox", aspects:['passive']},
 { name:"Tans-A-Hide" },
 { name:"Tastes-Like-Honey", aspects:['pussy-slut.2','oral-lover.3'], restriction:_female },
 ...
 { name:"The-Color-Of-A-Dream", aspects:['passive.2'], restriction:_female },
 ...
 { name:"Tight-Like-Tiger", aspects:['anal-slut'], triggers:['strong'], restriction:_male },
 { name:"Too-Small", triggers:['short','weak'], restriction:_female },
 { name:"Tricks-A-Man" },
 ...
 { name:"Wants-A-Pony", aspects:['beast-lover.3'], restriction:_female },
 ...
 { name:"Whats-Her-Face", restriction:_female },
 { name:"Whats-His-Face", restriction:_male },
 { name:"Wind-On-Her-Scales", aspects:['passive'], triggers:['beautiful'], restriction:_female },
